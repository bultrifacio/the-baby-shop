const esTranslations: Record<string, string> = {
    ...
    'filter.bar.button.menu': 'Filtros',
    'filter.bar.select.direction.placeholder': 'Ordenar por',
    'filter.bar.select.order.placeholder': 'Ordenar por',
    'filter.bar.search.input.placeholder': 'Buscar',
    'filter.bar.select.direction.asc': 'Asc',
    'filter.bar.select.direction.desc': 'Desc',
    'filter.bar.select.order.name': 'Nombre',
    'filter.bar.select.order.price': 'Precio',
    ...
    'filter.clear.button': 'Limpiar filtros',

    'product.details.request.error': 'No se puede obtener el producto. Por favor, inténtelo de nuevo en unos minutos.',

    'detail.color.message': 'Color:',
    'detail.composition.message': 'Composición:',

    'notFound.message': 'Lo sentimos, la página que has visitado no existe.',
    'notFound.back.button': 'Volver al inicio',

    'breadcrumb.bar.home': 'Inicio',
    'breadcrumb.bar.store': 'Tiendas',
    'breadcrumb.bar.products': 'Productos',
};
